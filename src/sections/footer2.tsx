...
export const Footer2 = () => {
  return (
    <>
      <footer
        className="footer-bg relative border border-white/10 2xl:h-[450px] m-10 p-10 h-fit lg:pb-20 max-w-[1500px] mx-auto mb-8 rounded-lg overflow-hidden radial-gradient-bg
                   [--gradient-center:#f3f4f6] [--gradient-edge:#f3f4f6]
                   dark:[--gradient-center:#02081765] dark:[--gradient-edge:#020817]"
      >
        <div className="gap-10 sm:flex justify-between p-5 2xl:py-10 py-5 dark:bg-[#100520] dark:opacity-70 rounded-sm rounded-b-none text-white">
